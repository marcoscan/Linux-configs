 ...
 */
static char font[] = "Noto Mono:style=regular:pixelsize=11:antialias=true:hinting=true";
...
/* Replaced shift with CTRL */
#define MODKEY ControlMask

/* Changed copy-paste shortcuts removing shift */
